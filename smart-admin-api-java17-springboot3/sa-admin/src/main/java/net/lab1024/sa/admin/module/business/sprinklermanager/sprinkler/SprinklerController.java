...
public class SprinklerController {
    ...
    public ResponseDTO<PageResult<SprinklerVO>> queryByPage(@RequestBody @Valid SprinklerQueryFormList queryFormList) {
        return sprinklerService.queryByPage(queryFormList);
    }
